...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'avatar' => 'nullable|image|mimes:jpg,jpeg,png,gif,webp,jfif|max:2048',
            'id_photo' => 'nullable|required_if:role,seller|image|mimes:jpg,jpeg,png,gif,webp,jfif|max:2048',
